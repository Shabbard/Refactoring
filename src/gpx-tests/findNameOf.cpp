...
BOOST_AUTO_TEST_CASE(CanFindASignularMixedExistingPosition)
{
    ...
    Route route = Route(LogFiles::GPXRoutesDir + createGPXLog("N0741707-CanFindASignularMixedExistingPosition", routeData), isFileName);
...
BOOST_AUTO_TEST_CASE(CanFindASignularZeroExistingPosition)
{
    ...
    Route route = Route(LogFiles::GPXRoutesDir + createGPXLog("N0741707-CanFindASignularZeroExistingPosition", routeData), isFileName);
...
BOOST_AUTO_TEST_CASE(CanFindAnExistingPositivePositionWithDuplicateEntries)
{
    ...
    Route route = Route(LogFiles::GPXRoutesDir + createGPXLog("N0741707-CanFindAnExistingPositivePositionWithDuplicateEntries", routeData), isFileName);
...
BOOST_AUTO_TEST_CASE(CanFindAnExistingNegativePositionWithDuplicateEntries)
{
    ...
    Route route = Route(LogFiles::GPXRoutesDir + createGPXLog("N0741707-CanFindAnExistingNegativePositionWithDuplicateEntries", routeData), isFileName);
...
BOOST_AUTO_TEST_CASE(CanFindAnExistingMixedPositionWithDuplicateEntries)
{
    ...
    Route route = Route(LogFiles::GPXRoutesDir + createGPXLog("N0741707-CanFindAnExistingMixedPositionWithDuplicateEntries", routeData), isFileName);
...
BOOST_AUTO_TEST_CASE(CanFindAnExistingZeroExistingPositionWithDuplicates)
{
    GridWorldRoute routeData = GridWorldRoute("AABB", GridWorld(Earth::EquatorialMeridian, 0, 0));
    Route route = Route(LogFiles::GPXRoutesDir + createGPXLog("N0741707-CanFindAnExistingZeroExistingPositionWithDuplicates", routeData), isFileName);
...
BOOST_AUTO_TEST_CASE(ThrowsOutOfRangeWhenAPositionIsNotFound)
{
    ...
    Route route = Route(LogFiles::GPXRoutesDir + createGPXLog("N0741707-ThrowsOutOfRangeWhenAPositionIsNotFound", routeData), isFileName);
