...
// checks values with a larger positive than negative gradient, should return a positive gradient
...
// checks values with a larger negative than positive gradient, should return a positive gradient
